...
#define LCD_SET_PROGRESS_MANUALLY // For Ender 3 V2 Octoprint Support
  ...
  #define SD_IGNORE_AT_STARTUP              // Don't mount the SD card when starting up (for OP FirmwareUpdater plugin)
   ...
   * point in the file.
   */
  //#define POWER_LOSS_RECOVERY         // Disabling this to support OctoPrint FirmwareUpdater plugin,
                                        // which benefits from SD_IGNORE_AT_STARTUP which is incompatible with PLR.
